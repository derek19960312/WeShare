package weshare.groupfour.derek.ws;
...
public class GrabCourseWebSocketClient extends WebSocketClient {
    ...
    public GrabCourseWebSocketClient(URI serverURI, Context context) {
...
//        }
    ...
    private void sendMessageBroadcast(String messageinscId, String message) {
        Intent intent = new Intent(messageinscId);
